...
%   Version: 1.0, 13 October 2015.
    ...
    methods (Static)
        ...
        %INITJAVA Initializes the required Java class.
            ...
            if ~mvc.view.internal.dndcontrol.isInitialized()
                ...
                javaaddpath(classpath);   %% was javaclasspath, changed by PJR             
            end 
        end
    ...
    methods
        ...
        %   callback functions for dropping of files and text.
            ...
            assert(mvc.view.internal.dndcontrol.isInitialized(), ...
                'Javaclass MLDropTarget not found. Call mvc.view.internal.dndcontrol.initJava() for initialization.')
             
            % Construct DropTarget            
            obj.dropTarget = handle(javaObjectEDT('MLDropTarget'),'CallbackProperties');
            set(obj.dropTarget,'DropCallback',{@mvc.view.internal.dndcontrol.DndCallback,obj});
            set(obj.dropTarget,'DragEnterCallback',{@mvc.view.internal.dndcontrol.DndCallback,obj});
    ...
    methods (Static)
        ...
        %   Java class is visible in the Java classpath.
            ...
            dndobj = mvc.view.internal.dndcontrol(jTextArea);
