classdef (ConstructOnLoad) Spoiler < awi.model.ControlSurface
    %Spoiler Defines an instance of a trailing edge control surface known 
    %as a "Spoiler".
    %
    ...
    %
    % The parameterisation of the 'Spoiler' object is no different to the
    ...
    methods % construction
        function obj = Spoiler(varargin)
            ...
            obj.HingeLine = 'LE';
            obj.FaceColor = [255 215 0] ./ 256; %Gold coloured (http://www.tayloredmktg.com/rgb/)
