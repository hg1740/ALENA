...
%             end
            ...
            switch AERO.Interp.Type(ninterp)
                ...
                case 2
                    ...
                    Ic = rbf_interfaceD(str_data, AERO.lattice.COLLOC(PANEL+ntot, 1:3), weight, rmax, tcond);
                    %Ic_check = rbf_interface(str_data, AERO.lattice.COLLOC(PANEL+ntot, 1:3), weight, rmax, tcond);
            end
            ...
            if i==1 && n==1
                ri = [(PANEL(r)+ntot)];
                ci = [AERO.Set.Node(1,nset).data(c)];
                vi = [v];
            else
                ri = [ri; (PANEL(r)+ntot)];
                ci = [ci; AERO.Set.Node(1,nset).data(c)];
                vi = [vi; v];
            end
