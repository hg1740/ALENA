...
for n=1:nbar
	...
	DA2(1:3,4:6) =    (-F1C * NID1 + F2C * NIID1)* f1c * G1;
	DA2(1:3,7:9) =     F1C * (NID2 - eye(3)) - F2C * (NIID2 - eye(3));
	DA2(1:3,10:12) =  (-F1C * NID2  + F2C * NIID2) * f2c * G2;
	DA2(1:3,13:15) =   F1C * NID3 - F2C * NIID3;
	DA2(1:3,16:18) =  (-F1C * NID3 + F2C * NIID3) * f3c * G3;
    
%     DA2(1:3,1:3) = F1C * NID1-DA3(1:3,1:3);
%     DA2(1:3,4:6) = -DA1(1:3,4:6)-DA3(1:3,4:6);
%     DA2(1:3,7:9) = -DA1(1:3,1:3)- F2C * (NIID2 - eye(3));
%     DA2(1:3,10:12) = -DA1(1:3,10:12)-DA3(1:3,10:12);
%     DA2(1:3,13:15) = -DA1(1:3,13:15)- F2C * NIID3;
%     DA2(1:3,16:18) = -DA1(1:3,16:18)- DA3(1:3,16:18);
