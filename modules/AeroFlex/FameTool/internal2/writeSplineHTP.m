function obj = writeSplineHTP(obj)
...
WingCAERO   = findobj(obj.Mdl.Caero,'part','StbdHTP');

WingNODES   = findobj(obj.Mdl.Grid,'part','StbdHTP','-and','type','Beam');

WingAeroNODES   = findobj(obj.Mdl.Grid,'part','StbdHTP','-and','type','Aerodynamic');
